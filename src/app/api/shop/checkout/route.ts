...
/** チップ購入（Stripe）: STRIPE_SECRET_KEY 必須。NEXT_PUBLIC_APP_URL または VERCEL_URL で success/cancel のリダイレクト先を指定 */
...
/** POST: チップパックの Stripe Checkout セッションを作成。body: { packId }。戻り値: { url } */
